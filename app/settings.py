...
DATABASE_NAME = 'owenmead_keg'          # Or path to database file if using sqlite3.
DATABASE_USER = 'owenmead_keg'          # Not used with sqlite3.
DATABASE_PASSWORD = 'r0v3rb0y'          # Not used with sqlite3.
