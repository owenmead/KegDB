...
var aLoadImgSrc = '/awesome-box/images/aBox-loading.gif'; // where is the loading image? (recommend absolute)
var siteURL = 'http://localhost:8000/'; // requires trailing / (after .com)
